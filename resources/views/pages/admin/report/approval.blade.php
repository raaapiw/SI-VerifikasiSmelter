...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($order->state_report) ? 'Edit Status Final Report': 'Upload Status Final Report'}}</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">{{ isset($order->state_report) ? 'Edit Status Final Report':'Upload Status Final Report'}}</li>
        </ol>
    </div>
</div>
@endsection
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <center>
                                    PERIKSA KEMBALI KELENGKAPAN DOKUMEN SEBELUM MELAKUKAN APPROVE DOKUMEN
                                    <input type="hidden" name="state_report" value=1>
                                    </center>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                                <button type="submit" class="btn btn-success" value="upload"> Approve </button></a>

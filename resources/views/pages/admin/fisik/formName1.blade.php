...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($document) ? 'Tambah Dokumen Kemajuan Fisik': 'Tambah Dokumen Kemajuan Fisik'}}</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">{{ isset($document) ? 'Tambah Dokumen Kemajuan Fisik':'Tambah Dokumen Kemajuan Fisik'}}</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-body">
                <form action="{{ isset($document) ? route('admin.document.update1', $document->id) : route('admin.document.store1')}}" method="POST" enctype="multipart/form-data">

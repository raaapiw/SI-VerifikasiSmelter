...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($docper) ? 'Edit Nama Dokumen': 'Tambah Nama Dokumen'}}</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">{{ isset($docper) ? 'Edit Nama Dokumen':'Tambah Nama Dokumen'}}</li>
        </ol>
    </div>
</div>
@endsection

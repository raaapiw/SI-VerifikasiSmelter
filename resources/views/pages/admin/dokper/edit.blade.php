...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($docper) ? 'Edit Nama Dokumen': 'docper Nama Dokumen'}}</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">{{ isset($docper) ? 'Edit Nama Dokumen':'docper Nama Dokumen'}}</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-body">
                <form action="{{route('admin.docper.update1', $docper->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nameFile" name="type" required placeholder="{{$docper->type}}"/>
                                            </div>
                                        </center>
                                    </div>
                                </div>

...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Tambah Dokumen Verifikasi Kemajuan Fisik</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Tambah Dokumen Verifikasi Kemajuan Fisik</li>
        </ol>
    </div>
</div>
@endsection
                        ...
                        <tbody>
                            ...
                            @foreach($order as $key=>$row)
                                <tr>
                                    ...
                                    <td><center>
                                            <a href="{{ route('client.document.detail', $row->id)}}"><span><i class="fa fa-send"></i></span></a>
                                        </center>
                                    </td>
                                </tr>                            
                            @endforeach

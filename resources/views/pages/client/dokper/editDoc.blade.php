...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-body">
                <form action="{{  route('client.docper.update',$document->id) }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="order_id" value="{{$document->order_id}}">
                    <div class="form-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" disabled id="nameFile" placeholder="{{$document->type}}">
                                        </div>

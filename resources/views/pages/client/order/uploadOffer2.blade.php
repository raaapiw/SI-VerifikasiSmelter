...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($order->state_offer) ? 'Edit Surat Penawaran': 'Upload Surat Penawaran'}}</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">{{ isset($order->state_offer) ? 'Edit Surat Penawaran':'Upload Surat Penawaran'}}</li>
        </ol>
    </div>
</div>
@endsection
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input type="file" id="file" name="state_offer" class="dropify" accept="application/pdf" required/>
                                </div>
                            </div>
                        </div>
